...
.card { background: #ffffff; border-radius: 20px; padding: 20px 24px 22px; box-shadow: 0 1px 2px rgba(22,33,15,.04), 0 8px 32px rgba(57,169,0,.09); margin-bottom: 16px; }
...
.festivos-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 10px; }
.festivo-card { display: flex; align-items: center; gap: 14px; padding: 12px; background: #F7F9F5; border-radius: 12px; border: 1px solid #E2E6DE; }
...
.fichas-check-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 8px; max-height: 180px; overflow-y: auto; padding: 8px; background: #F7F9F5; border: 1px solid #E2E6DE; border-radius: 8px; }
